...
const mongoUrl = `mongodb://${process.env.MONGOUSER}:${process.env.MONGOPASSWORD}@${hosts}/${process.env.MONGODB}${process.env.MONGOREPL ? `?replicaSet=${process.env.MONGOREPL}` : ''}`;
